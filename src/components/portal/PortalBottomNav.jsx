...
import {
    Home, User, GraduationCap, Users2,
    Coffee
} from 'lucide-react';
...
export default function PortalBottomNav({ user, currentPage }) {
    ...
    const navItems = [
        ...
        { 
            name: 'Community', 
            page: 'CommunityEvents', 
            icon: Coffee,
            current: currentPage === 'CommunityEvents'
        },
        { 
            name: 'Profile', 
            page: 'MyProfile', 
            icon: User,
            current: currentPage === 'MyProfile' || currentPage === 'MyCertificates' || currentPage === 'PortalMembershipTiers' || currentPage === 'ManageOrganisation'
        },
    ];
