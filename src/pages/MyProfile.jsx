...
import { cancelSubscription } from '@/api/functions';
                ...
                <main className="flex-1 overflow-y-auto p-6 md:p-8 pb-20 md:pb-8">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <Tabs defaultValue="profile" className="space-y-4 md:space-y-6">
                            <TabsList className="grid w-full grid-cols-5 gap-1 h-auto bg-slate-100 p-1 md:w-auto md:inline-flex">
                                ...
                                <TabsTrigger value="referrals" className="gap-1 md:gap-2 text-xs md:text-sm px-2 md:px-3 py-2">
                            ...
                            {/* Referrals Tab */}
                            <TabsContent value="referrals" className="space-y-4 md:space-y-6 px-1">
