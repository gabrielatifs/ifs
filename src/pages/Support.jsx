                    ...
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; background-color: #ffffff;">
                            ...
                            <div style="margin-top: 30px; text-align: center;">
                                <a href="${window.location.origin}/AdminSupport" style="background-color: #7c3aed; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">View Ticket in Admin Portal</a>
                            </div>
                        </div>
                    `
                });
