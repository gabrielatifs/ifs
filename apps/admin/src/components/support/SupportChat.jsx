...
import { ScrollArea } from '@ifs/shared/components/ui/scroll-area';
import { Avatar, AvatarFallback, AvatarImage } from '@ifs/shared/components/ui/avatar';
...
export default function SupportChat({ ticket, onSendMessage, isSubmitting }) {
    ...
    const createdAt = messages[0]?.timestamp || ticket?.lastMessageAt || new Date();
                ...
                <div className="space-y-6 max-w-3xl mx-auto">
                    ...
                    <div className="flex justify-center">
                        <div className="bg-slate-100 text-slate-500 text-xs px-3 py-1 rounded-full flex items-center gap-1">
                            ...
                            Ticket created on {format(new Date(createdAt), 'MMMM d, yyyy')}
                        </div>
                    </div>
