...
const DefinitionRow = ({ term, definition }) => (
    <tr className="border-b border-gray-200">
        <td className="py-3 pr-4 font-semibold text-gray-900 align-top">{term}</td>
        <td className="py-3 text-gray-700">{definition}</td>
    </tr>
);
                ...
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            Independent Federation for Safeguarding takes the privacy of your information very seriously. This Privacy Policy applies to our use of any and all data collected by us or provided by you.
                        </p>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-12 rounded-r-lg">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-blue-900 mb-2">Please read this Privacy Policy carefully</p>
                ...
                {/* Definitions */}
                <Section title="Definitions and Interpretation" icon={FileText}>
                    <p className="text-gray-700 mb-6">In this Privacy Policy, the following definitions are used:</p>
                ...
                {/* Scope */}
                <Section title="Scope of this Privacy Policy" icon={Eye}>
                ...
                {/* Data Collected */}
                <Section title="Data Collected" icon={Lock}>
                    <p className="text-gray-700 mb-4">We may collect the following Data, which includes personal Data, from you:</p>
                ...
                <Section title="How We Collect Data">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Data That is Given to Us by You</h3>
                    <p className="text-gray-700 mb-4">Independent Federation for Safeguarding will collect your Data in a number of ways, for example:</p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Data That is Collected Automatically</h3>
                    <p className="text-gray-700 mb-4">To the extent that you access the Website, we will collect your Data automatically, for example:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <Section title="Our Use of Data">
                    <p className="text-gray-700 mb-4">Any or all of the above Data may be required by us from time to time in order to provide you with the best possible service and experience when using our Website. Specifically, Data may be used by us for the following reasons:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Direct Marketing Consent</h3>
                    <p className="text-gray-700 mb-4">For the delivery of direct marketing to you via e-mail, we'll need your consent:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <Section title="Who We Share Data With">
                    <p className="text-gray-700 mb-4">We may share your Data with the following groups of people for the following reasons:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                {/* Keeping Data Secure */}
                <Section title="Keeping Data Secure" icon={Lock}>
                    <p className="text-gray-700 mb-4">We will use technical and organisational measures to safeguard your Data, for example:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
                ...
                <Section title="Your Rights" icon={Shield}>
                    <p className="text-gray-700 mb-4">You have the following rights in relation to your Data:</p>
                ...
                <Section title="Cookies">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <h4 className="font-semibold text-gray-900 mb-2">Analytical/Performance Cookies</h4>
                                <p className="text-gray-700 text-sm">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Cookies We Use</h3>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 text-center text-sm text-gray-500">
                    <p>
                        This Privacy Policy was created on 8th November 2025 using a document from{' '}
