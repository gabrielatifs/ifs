      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <DialogTitle className="text-2xl font-bold text-slate-900">Organisation Invitation</DialogTitle>
          </div>
          <DialogDescription className="text-slate-600 text-base leading-relaxed pt-2">
            You’ve been invited by <strong>{invite.inviterName}</strong> to join <strong>{invite.organisationName}</strong> on
            the IfS platform.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Button onClick={handleAccept} disabled={accepting} className="flex-1 bg-purple-600 hover:bg-purple-700 h-11">
            {accepting ? (
              <>
          ...
          <Button onClick={handleDecline} disabled={accepting} variant="outline" className="flex-1 border-slate-300 h-11">
            Decline
          </Button>
        </div>
      </DialogContent>
