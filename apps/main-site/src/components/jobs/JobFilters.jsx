...
import { Slider } from '@ifs/shared/components/ui/slider';
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 md:p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        {/* Radius Filter */}
        <div>
          <Select value={filters.radius} onValueChange={(value) => onFilterChange('radius', value)} disabled={!filters.coordinates}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Select value={filters.workPattern} onValueChange={(value) => onFilterChange('workPattern', value)}>
          <SelectTrigger className="bg-white">
          ...
          <PopoverContent className="w-80">
            <div className="grid gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Adjust the slider to filter by annual salary.</p>
              </div>
              <div className="pt-2">
                <Slider
      ...
      {hasActiveFilters && (
        <div className="flex justify-end pt-4">
          <Button variant="ghost" size="sm" onClick={onClearFilters} className="text-slate-500 hover:text-slate-900">
