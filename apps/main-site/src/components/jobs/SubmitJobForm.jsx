  ...
  return (
    <Card className="border-slate-200 shadow-sm">
      <CardHeader className="border-b border-slate-200">
        ...
        <CardDescription>Post a job opportunity that will be reviewed by our team before publication</CardDescription>
      </CardHeader>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({ ...formData, workingArrangement: value })}
                  required
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
