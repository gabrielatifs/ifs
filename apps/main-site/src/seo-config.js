...
export const pathToPageName = {
  ...
  '/training': 'Training',
  '/training/cpd-training': 'CPDTrainingMarketing',
  '/Training/IntroductoryCourses': 'IntroductoryCourses',
  '/training/introductory-courses': 'IntroductoryCourses',
  '/Training/AdvancedCourses': 'AdvancedCourses',
  '/training/advanced-courses': 'AdvancedCourses',
  '/Training/RefresherCourses': 'RefresherCourses',
  '/training/refresher-courses': 'RefresherCourses',
  '/Training/SpecialistCourses': 'SpecialistCourses',
  '/training/specialist-courses': 'SpecialistCourses',
  ...
  '/jobs-board': 'JobsBoardMarketing',
  '/WhyJoinUs': 'WhyJoinUs',
  '/why-join-us': 'WhyJoinUs',
  '/Membership': 'Membership',
  '/membership': 'Membership',
  '/Membership/AssociateMembership': 'AssociateMembership',
  '/membership/associate-membership': 'AssociateMembership',
  '/Membership/FullMembership': 'FullMembership',
  '/membership/full-membership': 'FullMembership',
  '/Membership/Fellowship': 'Fellowship',
  '/membership/fellowship': 'Fellowship',
  '/Membership/MemberBenefits': 'MemberBenefits',
  '/membership/member-benefits': 'MemberBenefits',
  '/Membership/WhyJoinUs': 'WhyJoinUs',
  '/membership/why-join-us': 'WhyJoinUs',
...
export const pageSEO = {
  ...
  ForumsAndWorkshops: {
    ...
    canonical: '/forums-and-workshops',
  ...
  IntroductoryCourses: {
    ...
    canonical: '/training/introductory-courses',
  ...
  AdvancedCourses: {
    ...
    canonical: '/training/advanced-courses',
  ...
  RefresherCourses: {
    ...
    canonical: '/training/refresher-courses',
  ...
  SpecialistCourses: {
    ...
    canonical: '/training/specialist-courses',
  ...
  CPDTrainingMarketing: {
    ...
    canonical: '/training/cpd-training',
  ...
  WhyJoinUs: {
    ...
    canonical: '/membership/why-join-us',
  ...
  MemberBenefits: {
    ...
    canonical: '/membership/member-benefits',
  ...
  AssociateMembership: {
    ...
    canonical: '/membership/associate-membership',
  ...
  FullMembership: {
    ...
    canonical: '/membership/full-membership',
  ...
  Fellowship: {
    ...
    canonical: '/membership/fellowship',
  ...
  ArticlesOfAssociation: {
    ...
    canonical: '/articles-of-association',
  ...
  RegisteredOrganisation: {
    ...
    canonical: '/registered-organisation',
  ...
  EventRegistrationSuccess: {
    ...
    canonical: '/event-registration-success',
  ...
  MemberAccessRequired: {
    ...
    canonical: '/member-access-required',
...
export const sitemapStaticRoutes = [
  ...
  { path: '/membership-tiers', priority: 0.8, changefreq: 'monthly' },
  { path: '/membership/member-benefits', priority: 0.8, changefreq: 'monthly' },
  { path: '/membership/associate-membership', priority: 0.8, changefreq: 'monthly' },
  { path: '/membership/full-membership', priority: 0.8, changefreq: 'monthly' },
  { path: '/membership/fellowship', priority: 0.7, changefreq: 'monthly' },
  { path: '/membership/why-join-us', priority: 0.8, changefreq: 'monthly' },
  { path: '/join-us', priority: 0.8, changefreq: 'monthly' },
  { path: '/registered-organisation', priority: 0.7, changefreq: 'monthly' },
  { path: '/training/cpd-training', priority: 0.8, changefreq: 'weekly' },
  { path: '/training/introductory-courses', priority: 0.7, changefreq: 'weekly' },
  { path: '/training/advanced-courses', priority: 0.7, changefreq: 'weekly' },
  { path: '/training/refresher-courses', priority: 0.7, changefreq: 'weekly' },
  { path: '/training/specialist-courses', priority: 0.7, changefreq: 'weekly' },
  { path: '/conferences', priority: 0.7, changefreq: 'weekly' },
  { path: '/forums-and-workshops', priority: 0.7, changefreq: 'weekly' },
  { path: '/jobs-board', priority: 0.8, changefreq: 'daily' },
  { path: '/supervision', priority: 0.7, changefreq: 'monthly' },
  { path: '/signposting', priority: 0.6, changefreq: 'monthly' },
  { path: '/team', priority: 0.6, changefreq: 'monthly' },
  { path: '/governance', priority: 0.5, changefreq: 'monthly' },
  { path: '/board', priority: 0.5, changefreq: 'monthly' },
  { path: '/articles-of-association', priority: 0.4, changefreq: 'yearly' },
